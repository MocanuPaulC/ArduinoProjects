...
// const uint8_t SEGMENT_BOMB[] = {0x7F,0x7B,0xEF,0xE9,0x4B,0x80,0x00};
const uint8_t SEGMENT_ONE[4] ={0xFF,0x7F,0xFF,0xFF};
const uint8_t SEGMENT_TWO[4] ={0xFF,0x7B,0xEF,0xFF};

//0xFF,0x7B,0xEF,0xFF



const uint8_t SEGMENT_BOMB[5][4] = { 
  {0xFF,0x7F,0xFF,0xFF}, //0
  {0xFF,0x7B,0xEF,0xFF}, //1
  {0xFF,0x4B,0xE9,0xFF}, //2 
  {0x80,0x4B,0xE9,0x80}, //3
  {0x00,0x00,0x00,0x00} //4
  };

void displayExplosion(int timer){
  timer=-timer;
  writeExplosionToSegment(0,SEGMENT_BOMB[timer][0]);
  _delay_ms(1);
  writeExplosionToSegment(1,SEGMENT_BOMB[timer][1]);
  _delay_ms(1);
  writeExplosionToSegment(2,SEGMENT_BOMB[timer][2]);
  _delay_ms(1);
  writeExplosionToSegment(3,SEGMENT_BOMB[timer][3]);
  _delay_ms(1);  
}

void writeExplosionToSegment(uint8_t segment, uint8_t value){
  cbi(PORTD, LATCH_DIO);
